 ...
 * @author Angelo ZERR
 */
public class QuteJavaCodeLensCollector2 extends AbstractQuteTemplateLinkCollector2 {
    ...
    public QuteJavaCodeLensCollector2(PsiFile typeRoot, List<CodeLens> lenses, IPsiUtils utils,
